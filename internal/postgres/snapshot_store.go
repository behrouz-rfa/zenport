...
//var _ es.AggregateNtp = (*SnapshotStore)(nil)
//
//func NewSnapshotStore(tableName string, db *sql.DB, registry registry.Registry) es.AggregateNtpMiddleware {
...
//	}
//
//	return func(store es.AggregateNtp) es.AggregateNtp {
//		snapshots.AggregateNtp = store
//		return snapshots
//	}
//}
//
...
//			return s.AggregateNtp.Load(ctx, aggregate)
//		}
//		return err
//	}
//
...
//
//	if err := s.AggregateNtp.Save(ctx, aggregate); err != nil {
//		return err
//	}
//
