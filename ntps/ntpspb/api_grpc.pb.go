...
func (c *timeServiceClient) GetTime(ctx context.Context, in *GetTimeRequest, opts ...grpc.CallOption) (*GetTimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/timespb.TimeService/GetTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TimeService_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/timespb.TimeService/GetTime",
	}
...
var TimeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "timespb.TimeService",
